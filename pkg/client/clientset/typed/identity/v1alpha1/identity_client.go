...
import (
	...
	v1alpha1 "k8s.io/identity/pkg/apis/identity/v1alpha1"
...
// IdentityV1alpha1Client is used to interact with features provided by the identity.k8s.io group.
type IdentityV1alpha1Client struct {
	restClient rest.Interface
}

func (c *IdentityV1alpha1Client) IdentityDocuments() IdentityDocumentInterface {
