...
import (
	...
	clientset "k8s.io/identity/pkg/client/clientset"
	identityinternalversion "k8s.io/identity/pkg/client/clientset/typed/identity/internalversion"
	fakeidentityinternalversion "k8s.io/identity/pkg/client/clientset/typed/identity/internalversion/fake"
	identityv1alpha1 "k8s.io/identity/pkg/client/clientset/typed/identity/v1alpha1"
	fakeidentityv1alpha1 "k8s.io/identity/pkg/client/clientset/typed/identity/v1alpha1/fake"
)
